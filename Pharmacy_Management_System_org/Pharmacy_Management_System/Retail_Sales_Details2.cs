...
{
    public partial class Retail_Sales_Details2 : Form
    {
        SqlConnection con;
        SqlCommand com,com1;
        String sql, sql1;
        public Retail_Sales_Details2()
        {
            InitializeComponent();
        ...
        private void Retail_Sales_Details2_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            com = new SqlCommand("select SUM(amount) from retail where billNo ='" + textBox1.Text + "'", con);
            //sql = "select * from details where CONVERT (varchar,mID) ='" + textBox12.Text + "'";
            SqlDataReader dr;
            dr = com.ExecuteReader();
            while (dr.Read())
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                sql = "insert into purchase values('" + ij + "','" + ab + "','" + cd + "','" + ef + "','" + ef + "','" + gh + "')";
